...
EShortcut ShortcutHandler::findShortcut(const std::string & identifier ) const
{
	static const std::map<std::string, EShortcut> shortcutNames = {
		...
		{"moveUpLeft",               EShortcut::MOVE_UP_LEFT              },
		{"moveUpRight",              EShortcut::MOVE_UP_RIGHT             },
		{"moveDownLeft",             EShortcut::MOVE_DOWN_LEFT            },
		{"moveDownRight",            EShortcut::MOVE_DOWN_RIGHT           },
		...
		{"adventureScrollLeft",      EShortcut::ADVENTURE_SCROLL_LEFT     },
		{"adventureScrollRight",     EShortcut::ADVENTURE_SCROLL_RIGHT    },
		{"adventureScrollUp",        EShortcut::ADVENTURE_SCROLL_UP       },
		{"adventureScrollDown",      EShortcut::ADVENTURE_SCROLL_DOWN     },
		...
		{"adventureAnnounceExits", EShortcut::ADVENTURE_ANNOUNCE_EXITS},
		...
		{ "battleJumpToUnit11",       EShortcut::BATTLE_JUMP_TO_UNIT_11    },
		{ "battleJumpToUnit12",       EShortcut::BATTLE_JUMP_TO_UNIT_12    },
		...
		{ "battleJumpToEnemy8",       EShortcut::BATTLE_JUMP_TO_ENEMY_8    },
		{ "battleJumpToEnemy9",       EShortcut::BATTLE_JUMP_TO_ENEMY_9    },
		{ "battleJumpToEnemy10",      EShortcut::BATTLE_JUMP_TO_ENEMY_10   },
		{ "battleJumpToEnemy11",      EShortcut::BATTLE_JUMP_TO_ENEMY_11   },
		{ "battleJumpToEnemy12",      EShortcut::BATTLE_JUMP_TO_ENEMY_12   },
		...
		{"battleAnnounceTurn",       EShortcut::BATTLE_ANNOUNCE_TURN      },
		{"battleAnnounceQueue",      EShortcut::BATTLE_ANNOUNCE_QUEUE     },
		{"battleOpenLog",            EShortcut::BATTLE_OPEN_LOG           },
